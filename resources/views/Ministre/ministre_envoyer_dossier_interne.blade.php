            ...
            <form action="/traiter_formulaire_envoi_dossier_interne" method="post" enctype="multipart/form-data" id="dossierForm">
                ...
                <div class="form-group">
                    ...
                    <select name="priorites" id="priorites">
                        <option value="urgente"><span class="priority-option priority-urgente">URGENT</span></option>
                        <option value="haute"><span class="priority-option priority-haute">HAUTE</span></option>
                        <option value="moyenne"><span class="priority-option priority-moyenne">MOYENNE</span></option>
                        <option value="basse"><span class="priority-option priority-basse">BASSE</span></option>
                    </select>
                </div>
