...
<body>
    ...
    <div class="espace_travail">
        <span class="envoi_dossier_interne"><i class="fa-solid fa-paper-plane"></i><span class="dossier_interne">Consulter résultats</span></span><br>
        <p>
            <div id="result">
                {{now()}} <br><br>
                Le dossier Intitulé à été traité et validé avec succès <br> <br>
                <a href="/voir_dossier/{{}}"><button class="options"><i class="fa-solid fa-eyes"></i>voir détails</button></a>
                <a href="/marquer_lu/{{}}"><button class="options">marquer comme lu</button></a>
            </div><br><br>
        </p>
    </div>
    <script>
