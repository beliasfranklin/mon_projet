...
<!--
<body>
  <form action="/charger" enctype="multipart/form-data" method="POST">
  @csrf
  Pièces jointes
  <div>
  ...
  Commentaires(optionnel)<br>
  <textarea name="commentaires" id="commentaire" cols="70" rows="10" placeholder="Commentaires sur le dossier"></textarea><br>
  @error('commentaires')
    <span style="color: red;">{{$message}}</span><br><br>
  @enderror
  <input type="submit" value="Envoyer dossier interne à la DEP">
</form>
{{$i=10}}
@if($i != 0)
    @php
...
<a href="/telecharger" target="_blank" rel="noopener noreferrer">cahier de chages</a>
