...
<body>
    ...
    <div class="espace_travail">
        <div class="boite-reponse" style="width: 100%; height: 50px; background-color: rgb(204, 255, 204); color: darkgreen; display: flex;  align-items: center; font-size: 20px; font-weight: bold;">
            <i class="fa-solid fa-circle-check" style="margin-left:10px;"></i> Dossier interne envoyé avec succès !
        </div>
        <span class="envoi_dossier_interne"><i class="fa-solid fa-paper-plane"></i><span class="dossier_interne">Envoyer dossier interne</span></span><br>
        <p class="formulaire_creer_utilisateur">
            <form action="/traiter_formulaire_envoi_dossier_interne" method="post" enctype="multipart/form-data">
                @csrf
                <span class="a">Intitulé du dossier</span><br> 
                <i class="fa-solid fa-folder" id="user"></i><input type="text" name="nom" id="nom" placeholder="Intitulé" required><br><br>
                <span class="a">Pièces jointes</span><br>
                <div class="documents">
                    <input type="file" name="files[]" id="files" multiple>
                </div>
                <span class="a">Définir la priorité</span><br>
                ...
                <span class="a">Commentaires(optionnel)</span><br>
                <textarea name="commentaires" id="commentaires" cols="70" rows="10" placeholder="Commentaires sur le dossier"></textarea><br>
