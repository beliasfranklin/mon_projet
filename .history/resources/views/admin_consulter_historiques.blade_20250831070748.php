    ...
    <div class="conteneur_menus">
        <div class="conteneur_titre_logo_minsante">
            ...
            @if($user->id==$users_roles->id_user && $users_roles->id_role==23)
                ...
                <li onclick="seDeconnecter()"><a href="/se deconnecter"><span style="color: #ff0000;"><i class="fa-solid fa-right-from-bracket" style="color: #ff0000;"></i>Se deconnecter</span></a></li>
            </ul>
            @endif
        </div>    
    </div>
