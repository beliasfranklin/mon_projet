...
<body>
    ...
    <script>
        ...
        function ajout(){
            ...
            a.innerHTML='<span class="a">Motif du rejet:<br></span><form method="post" action="/traitement_rejet_dossier/{{$d-}}">@csrf<textarea name="texte"cols="70" rows="10" placeholder="motif du rejet"></textarea><br><br><input type="submit" class="bouton-validation"></form>';
        }
    </script>
</body>
</html>