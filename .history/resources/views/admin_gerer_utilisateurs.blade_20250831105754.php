...
<body>
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            ...
                            <a href="/supprimer_utilisateur/{{$u->id}}" onclick="supprimerUtilisateur(event)" id="user" data-user-id="{{$u->id}}"><li><i class="fa-solid fa-user-xmark"></i>Supprimer</li></a>
    ...
    <script>
        ...
        function supprimerUtilisateur(event){
            const lien=document.getElementById('user');
            const id=lien.dataset.userId;
