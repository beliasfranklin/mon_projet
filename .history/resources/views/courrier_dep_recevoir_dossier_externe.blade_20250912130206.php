@php
    ...
    $dossiers_externes=Dossier::where('statutDossier','cree')->get();
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Dossiers externes - DEP MINSANTE</title>
    <style>
        body{
...
<body>
    ...
    <div class="espace_travail">
        <span class="utilisateurs"><i class="fa-solid fa-inbox"></i><span class="users">Dossiers externe recus</span></span><br>
        <p>   
        ...
        <span class="liste-historiques">
            Liste des dossiers externes recus<br>
        </span><br>
        <table>
            <thead>
                <tr>
                    <th>#</th>
                    <th>Intitulé ou objet</th>
                    <th>Envoyé par</th>
            ...
            <tbody>
                @foreach ($dossiers_externes as $dossiers_externes)
                    <tr>
                        <td>{{$dossiers_externes->id}}</td>
                        <td>{{$dossiers_externes->intitule}}</td>
                        <td>{{$dossiers_externes->envoyer_par}}</td>
                        <td>{{$dossiers_externes->dateEnvoiDossier}}</td>
                        <td>
                            <ul>
                                <a href="/transfert_dossier/{{$dossiers_externes->id}}" onclick="transfert_dep(event)"><li><i class="fa-solid fa-share"></i>Transférer à la DEP</li></a>
                            </ul>
                        </td>
                    </tr>
                @endforeach
    ...
    <script>
        ...
        function transfert_dep(event){
            event.preventDefault();
            if(confirm("voulez vous effectuer cette action ?")){
                window.location.href="/transfert_dep/{{$dossiers_externes->id}}";
            }
        }
    </script>
