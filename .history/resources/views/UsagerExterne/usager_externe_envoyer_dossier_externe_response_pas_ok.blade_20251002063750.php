...
<body>
    ...
    <div class="conteneur_menus" id="sideMenu">
        <div class="conteneur_titre_logo_minsante">
            ...
            <ul class="menus">
                ...
                <li><a href="/resultats"><i class="fa-solid fa-bell"></i>Consulter résultats</a></li>
    ...
    <div class="espace_travail">
        ...
        <div class="boite-reponse">
            <i class="fa-solid fa-circle-xmark"></i> Dossier non envoyé car aucun membre du courrier de la DEP n'est disponible pour le moment.
        </div>

        <!-- Information box -->
        <div class="info-box">
            <i class="fa-solid fa-info-circle"></i>
            <strong>Information :</strong> Votre dossier sera envoyé au service courrier de la DEP pour traitement et validation.
        </div>

        <div class="envoi_dossier_interne">
            <i class="fa-solid fa-paper-plane"></i>
            <span class="dossier_interne">Envoyer dossier externe</span>
        </div>
        
        <div class="formulaire_creer_utilisateur">
            <form action="/traiter_formulaire_envoi_dossier_externe" method="post" enctype="multipart/form-data" id="dossierForm">
                @csrf
                
                <div class="form-group">
                    <span class="a">Intitulé ou objet d'envoi du dossier</span>
                    <i class="fa-solid fa-folder"></i>
                    <input type="text" name="nom" id="nom" placeholder="Intitulé ou objet du dossier" required value="{{ old('nom') }}">
                    @error('nom')
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <input type="submit" value="Envoyer dossier externe à la DEP" class="bouton-validation">
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('dossierForm').addEventListener('submit', function(e) {
            ...
            if (!nom) {
                e.preventDefault();
                alert('Veuillez saisir l\'intitulé ou l\'objet du dossier.');
                return false;
            }
