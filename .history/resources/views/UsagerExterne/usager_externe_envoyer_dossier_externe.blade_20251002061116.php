...
<body>
    ...
    <div class="conteneur_menus" id="sideMenu">
        <div class="conteneur_titre_logo_minsante">
            <img src="dep-minsante.png" alt="logo-minsante" class="logo-minsante">
    ...
    <div class="espace_travail">
        ...
        <div class="info-box">
            ...
            <strong>Information :</strong> Votre dossier sera envoyé au service courrier de la DEP pour traitement.
        </div>
        ...
        <div class="formulaire_creer_utilisateur">
            <form action="/traiter_formulaire_envoi_dossier_externe" method="post" enctype="multipart/form-data" id="dossierForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nom" id="nom" placeholder="Intitulé ou objet du dossier" value="{{ old('nom') }}">
                    @error('nom')
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <input type="submit" value="Envoyer dossier externe au courrier" class="bouton-validation">
                </div>
            </form>
        </div>
    </div>
