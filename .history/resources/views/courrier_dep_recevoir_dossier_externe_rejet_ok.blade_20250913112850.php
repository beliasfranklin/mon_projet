...
<body>
    ...
    <div class="espace_travail">
        <div class="boite-reponse" style="width: 100%; height: 50px; background-color: rgb(204, 255, 204); color: darkgreen; display: flex;  align-items: center; font-size: 20px; font-weight: bold;">
            <i class="fa-solid fa-circle-check" style="margin-left:10px;"></i> Envoi de la requete de rejet du dossier externe à l'utilisateur {{}}!
        </div>
            ...
            <tbody>
                @foreach ($dossiers_externes as $d)
                    <tr>
                        ...
                        <td>{{$d->intitule}}</td>
                        <td>{{$d->envoyer_par}}</td>
                        <td>{{$d->dateEnvoiUsagerExterne}}</td>
                        <td>
                            <ul>
                                <a href="/voir_dossier_externe/{{$d->id}}"><li><i class="fa-solid fa-share"></i>voir dossier</li></a>
                            </ul>
                        </td>
                    </tr>
                @endforeach
