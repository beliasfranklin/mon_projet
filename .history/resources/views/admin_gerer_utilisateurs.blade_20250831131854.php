...
<body>
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            ...
                            <a href="/supprimer_utilisateur/{{$u->id}}" onclick="supprimerUtilisateur(event)" class="user" data-user-><li><i class="fa-solid fa-user-xmark"></i>Supprimer</li></a>
    ...
    <script>
        ...
        function supprimerUtilisateur(event){
            let lien=document.getElementById('user');
