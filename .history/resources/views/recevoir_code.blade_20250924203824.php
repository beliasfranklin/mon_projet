...
<head>
    ...
    <title>Recevoir code - DEP MINSANTE</title>
...
<body>
    <div>
        <div class="boite-erreur" style="width: 100%; min-height: 50px; background-color: rgb(204, 255, 204); color: darkgreen; display: flex; justify-content: center; align-items: center; font-size: 20px; font-weight: bold;">
            <i class="fa-solid fa-circle-check"></i> Code envoyé avec succès à l' email {{$user->email}} !
        </div>
    </div>
    <div class="boite-principale">
        <div class="boite-secondaire">
            ...
            <form method="post" action="/verification_code" style="flex:1;display:flex;align-items:center;justify-content:center;">
                @csrf
                <div class="boite-secondaire-boite-1-formulaire">
                    <h1 style="font-size: 2.2em; color:#473d83;">Verification du code</h1><br>
                    <p class="champ-email">
                        <b><span style="font-size: 1.1em; color:#473d83;">Entrez le code</span></b><br>
                    ...
                    <p>
                        <a href="/renvoi_code/{{$user->id}}" style="text-decoration: none; color: darkslateblue; font-size: 1em;">Renvoyer le code</a>
                    </p>
                </div>
            </form>
        </div>
