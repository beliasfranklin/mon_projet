...
<body>
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            ...
                            <a href="/supprimer_utilisateur/{{$u->id}}" onclick="supprimerUtilisateur(event)" class="user"><li><i class="fa-solid fa-user-xmark"></i>Supprimer</li></a>
    ...
    <script>
        ...
        function supprimerUtilisateur(event){
            lien=document.getElementByClassName('.user');
            event.preventDefault();  //empêche la redirection par défaut du lien
            alert(lien);
            /*if(confirm("voulez vous supprimer d&finitivement cet utilisateur ?")){
