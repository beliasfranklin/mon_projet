            ...
            <tbody>
                @foreach ($dossiers_externes as $d)
                    <tr>
                        ...
                        <td>
                            <ul>
                                <a href="/voir_dossier_externe/{{$d->id}}" onclick="event.preventDefault();if(confirm('voulez vous transferer ce dossier a la DEP ?'){window.location.href='/voir_dossier/{{$d->id}}';})"><li><i class="fa-solid fa-share"></i>Transférer à la DEP</li></a>
                            </ul>
                        </td>
                    </tr>
                @endforeach
