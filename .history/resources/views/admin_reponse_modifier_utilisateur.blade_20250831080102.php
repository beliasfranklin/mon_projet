...
<body>
    ...
    <div class="espace_travail">
        <div class="boite-reponse" style="width: 100%; height: 50px; background-color: rgb(204, 255, 204); color: darkgreen; display: flex;  align-items: center; font-size: 20px; font-weight: bold;">
            <i class="fa-solid fa-circle-check" style="margin-left:10px;"></i> Compte utilisateur modifié avec succès !
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @foreach ($all_users_structures as $us)
                            @if ($u->id==$us->id_user)
                                @foreach ($all_structures as $s)
                                    @if ($s->id==$us->id_role)
                                        {{$s->nomStructure}}    
                                    @endif         
                                @endforeach
                    ...
                    <td>
                        <ul>
                            ...
                            <a href="/supprimer_utilisateur/{{$u->id}}"><li><i class="fa-solid fa-user-xmark"></i>Supprimer</li></a>
