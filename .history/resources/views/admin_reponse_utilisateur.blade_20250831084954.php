        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            <a href="/modifier_utilisateur"><li><i class="fa-solid fa-user-pen"></i>Modifier</li></a>
                            <a href="/supprimer_utilisateur"><li><i class="fa-solid fa-user-xmark"></i>Supprimer</li></a>
                            <a href="/bloquer_utilisateur"><li><i class="fa-solid fa-user-lock"></i>Bloquer</li></a>
                        </ul>
                    </td>
                </tr> 
                @endforeach
