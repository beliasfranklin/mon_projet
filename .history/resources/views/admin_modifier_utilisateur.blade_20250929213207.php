    ...
    <div class="espace_travail">
        ...
        <p class="formulaire_modifier_utilisateur">
            <form action="/traiter_formulaire_modification_utilisateur/{{$user1->id}}" method="post">
                ...
                <i class="fa-solid fa-user" id="user"></i><input type="text" name="nom" id="nom" placeholder="Nom complet" required value="{{$user1->name}}"><br><br>
                <span class="a">Email </span><br>
                <i class="fa-solid fa-envelope"></i><input type="email" name="email" id="email" placeholder="Email" value="{{$user1->name}}"><br><br>
                <span class="a">Numéro de Téléphone (Pour Whatsapp de préférence) </span><br>
                <i class="fa-solid fa-phone"></i><input type="tel" name="tel" id="tel" placeholder="Numéro de téléphone" value="{{$tel[0]['numeroTelephone']}}"><br><br>
                <span class="a">Mot de passe </span><br>
                <i class="fa-solid fa-lock"></i><input type="password" name="mdp" id="mdp" required placeholder="Mot de passe" value="{{$user1->password}}"><br><br>
