...
<body>
    <div class="boite-principale">
        <div class="boite-secondaire">
            ...
            <form method="post" action="/reinitialiser_mot_de_passe/{{$user->id}}" style="flex:1;display:flex;align-items:center;justify-content:center;">
                @csrf
                <div class="boite-secondaire-boite-1-formulaire">
                    <h1 style="font-size: 2.2em; color:#473d83;">Modifier mot de passe, {{$user_email->email}}</h1><br>
                    <p class="champ-email">
                        <b><span style="font-size: 1.1em; color:#473d83;">Nouveau mot de passe</span></b><br>
                        <i class="fa-solid fa-lock"></i>
                        <input type="password" name="password" placeholder="Définir mot de passe" required/>
                        @error('password')
                            <div class="error" style="color: #b91c1c; font-size: 0.95em;">{{ $message }}</div>
                        @enderror
                    </p>
                    <p class="champ-mdp">
                        <b><span style="font-size: 1.1em; color:#473d83;">Confirmer le mot de passe</span></b><br>
                        <i class="fa-solid fa-lock"></i>
