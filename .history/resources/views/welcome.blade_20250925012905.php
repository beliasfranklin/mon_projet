...
<body>
    <div class="barre">
        ...
        <ul class="menus">
            ...
            <li><a href="#statistiques" style="text-decoration:none;color:inherit;">Statistiques</a></li>
    ...
    <div class="conteneur1">
        ...
        <p class="description_bienvenue">Ce système permet de gérer efficacement les dossiers internes et externes, d'assurer leur traçabilité, et d'automatiser la communication entre les différentes structures (DEP, CPP, CEI) et leurs membres.</p>
    </div>
    <div class="about-section" id="fonctionnement">
        ...
        <ul style="font-size:1.1em;line-height:1.7;color:#1e293b;">
            ...
            <li><b>Dossiers externes :</b> Arrivent directement au courrier de la DEP, puis suivent un circuit similaire d'attribution et de suivi.</li>
    ...
    <div class="about-section" id="about">
        ...
        <p>Ce système a été conçu pour répondre aux besoins spécifiques du Ministère de la Santé Publique du Cameroun, en modernisant la gestion documentaire, en renforçant la traçabilité et la sécurité, et en facilitant la collaboration entre les différentes entités (DEP, CPP, CEI).</p>
