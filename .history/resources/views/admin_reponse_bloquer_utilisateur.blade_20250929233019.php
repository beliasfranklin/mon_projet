...
<body>
    ...
    <div class="espace_travail">
        <div class="boite-reponse" style="width: 100%; height: 50px; background-color: rgb(204, 255, 204); color: darkgreen; display: flex;  align-items: center; font-size: 20px; font-weight: bold;">
            <i class="fa-solid fa-circle-check" style="margin-left:10px;"></i> Compte bloqué avec succès !
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            ...
                            @endphp
                            @if($statut === 'bloqué')
                                <a href="/debloquer_utilisateur/{{$u->id}}" onclick="debloquerUtilisateur(event)"><li style="background-color: #28a745;"><i class="fa-solid fa-unlock"></i>Débloquer</li></a>
                            @else
