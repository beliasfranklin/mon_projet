...
<body>
    <div class="boite-principale">
        <div class="boite-secondaire">
            ...
            <form method="post" action="/traiter_creation_compte">
                @csrf
                <div class="boite-secondaire-boite-1-formulaire">
                    <h1 style="font-size: 45px; color:#473d83;">Inscription</h1><br>
                    <p class="champ-email">
                        <b><span style="font-size: 20px; color:#473d83;">Votre nom</span></b><br>
                        <i class="fa-solid fa-user" style="color: #473d83;"></i>
                        <input type="text" name="nom" placeholder="Votre email"/>
                        @error('nom')
                            {{$message}} <br>
                        @enderror
                    </p>
                    ...
                    <p class="champ-mdp">
                        <b><span style="font-size: 20px; color:#473d83;">Confirmer votre mot de passe</span></b><br>
                        <i class="fa-solid fa-lock"></i>
                    ...
                    <p>
                        <a href="/connexion" style="text-decoration: none; color: darkslateblue; font-size: 18px;">Avez vous un compte ? Se connecter</a>
                    </p>
