...
<body>
    ...
    @if($user->id==$users_roles->id_user && $users_roles->id_role==26)
        <div class="espace_travail">
            ...
            <span class="users-ext">Membres Externes</span>
                    ...
                    <tbody>
                        @foreach ($users as $u)
                            <tr>
                                ...
                                <td data-label="Statut connexion">
                                    @php
                                ...
                                <td data-label="Actions">
                                    <ul class="actions-list">
                                        <a href="/admin_voir_details_utilisateur/{{$u->id}}">
                                            <li><i class="fa-solid fa-eye"></i>Voir détails</li>
                                        </a>
                                        <a href="/admin_modifier_role_utilisateur/{{$u->id}}">
                                            <li><i class="fa-solid fa-user-pen"></i>Modifier rôle</li>
                                        </a>
                                        <a href="/admin_bloquer_utilisateur/{{$u->id}}" onclick="return confirm('Voulez vous vraiment bloquer cet utilisateur ?')">
                                            <li><i class="fa-solid fa-user-lock"></i>Bloquer</li>
                                        </a>
                                        <a href="/admin_debloquer_utilisateur/{{$u->id}}" onclick="return confirm('Voulez vous vraiment débloquer cet utilisateur ?')">
                                            <li><i class="fa-solid fa-user-check"></i>Débloquer</li>
                                        </a>
                                    </ul>
                                </td>
                            </tr> 
