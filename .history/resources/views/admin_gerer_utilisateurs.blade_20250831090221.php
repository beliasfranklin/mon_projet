                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            ...
                            <a href="/supprimer_utilisateur/{{$u->id}}" onclick="supprimerUtilisateur()"><li><i class="fa-solid fa-user-xmark"></i>Supprimer</li></a>
    ...
    <script>
        ...
        function supprimerUtilisateur(event){
            ...
            if(confirm('voulez vous supprimer définitivement cet utilisateur ?')){
                window.location.href="/admin_supprimer_utilisateur/{id}";
            }
        }
    </script>
