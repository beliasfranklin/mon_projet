...
<body>
    ...
    <div class="espace_travail">
        ...
        <p class="formulaire_modifier_utilisateur">
            <form action="/traiter_formulaire_modification_utilisateur/{{$user1->id}}" method="get">
                @csrf
                ...
                <i class="fa-solid fa-envelope"></i><input type="email" name="email" id="email" placeholder="Email" required value="{{$user1->name}}"><br><br>
