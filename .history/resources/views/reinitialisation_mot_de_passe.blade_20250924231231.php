...
<body>
    <div class="boite-principale">
        <div class="boite-secondaire">
            ...
            <form method="post" action="/reinitialiser_mot_de_passe/{{$user_email->id}}" style="flex:1;display:flex;align-items:center;justify-content:center;">
                @csrf
                <div class="boite-secondaire-boite-1-formulaire">
                    ...
                    <input type="hidden" name="id" value="{{$user_email->id}}">
