...
<body>
    ...
    <div class="espace_travail">
        <span class="envoi_dossier_interne"><span class="dossier_interne">Détails du dossier envoyé à la DEP</span></span><br><br><br>
            ...
            <a href="/transfert_dep/{{$d->id}}" onclick="event.preventDefault();if(confirm('voulez vous transferer ce dossier a la DEP ?'){window.location.href='/transfert_dep/{{$d->id}}';})"><button class="bouton-validation">Envoyer Dossier à la DEP</button></a><br>
