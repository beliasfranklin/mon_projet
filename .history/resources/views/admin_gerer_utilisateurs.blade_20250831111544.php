...
<body>
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            ...
                            <a href="/supprimer_utilisateur/{{$u->id}}" onclick="supprimerUtilisateur(event)" id="user"><li><i class="fa-solid fa-user-xmark"></i>Supprimer</li></a>
    ...
    <script>
        ...
        function supprimerUtilisateur(event){
            ...
            const url=lien.getAtribute("href");
