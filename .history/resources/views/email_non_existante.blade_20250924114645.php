...
<body>
    <div class="boite-erreur" style="width: 100%; min-height: 50px; background-color: rgb(255, 204, 204); color: darkred; display: flex; justify-content: center; align-items: center; font-size: 20px; font-weight: bold;">
        <i class="fa-solid fa-circle-xmark"></i> Identifiants non existant !
    </div>
        ...
        <div class="boite-secondaire">
            <div class="boite-secondaire-boite-1">
                <div class="boite-secondaire-boite1-logo-minsante">
                    <img src="https://i.imgur.com/X8P2udd.png" alt="logo-minsante" style="width:100%;max-width:120px;"/>
                </div>
                <div class="boite-secondaire-boite1-nom-structure">
                    <h1>DEP-MINSANTE</h1>
                </div>
            </div>
            <form method="post" action="/envoi_code" style="flex:1;display:flex;align-items:center;justify-content:center;">
                @csrf
                <div class="boite-secondaire-boite-1-formulaire">
                    <h1 style="font-size: 2.2em; color:#473d83;">Mot de passe oublié</h1><br>
                    <p class="champ-email">
                        <b><span style="font-size: 1.1em; color:#473d83;">Entrez votre Email</span></b><br>
