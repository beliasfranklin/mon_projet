    ...
    <div class="espace_travail">
        @if($u != null){
            <div class="boite-reponse" style="width: 100%; height: 50px; background-color: rgb(204, 255, 204); color: darkgreen; display: flex;  align-items: center; font-size: 20px; font-weight: bold;">
                <i class="fa-solid fa-circle-check" style="margin-left:10px;"></i> Compte utilisateur créé avec succès !
            </div>
        }
        ...
        <p class="formulaire_creer_utilisateur">
            <form action="/traiter_formulaire_creation_utilisateur" method="post">
                ...
                <i class="fa-solid fa-user" id="user"></i><input type="text" name="nom" id="nom" placeholder="Nom complet" required><br><br>
                <span class="a">Email </span><br>
                <i class="fa-solid fa-envelope"></i><input type="email" name="email" id="email" placeholder="Email" required><br><br>
                <span class="a">Numéro de Téléphone (Pour Whatsapp de préférence) </span><br>
                <i class="fa-solid fa-phone"></i><input type="tel" name="tel" id="tel" required placeholder="Numéro de téléphone"><br><br>
