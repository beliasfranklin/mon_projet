...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Styles pour les rôles spécifiques */
        .role-badge {
            font-size: 12px;
...
<body>
    ...
    <div class="espace_travail">
        ...
        <div class="filter-forms">
            ...
            <form method="post" action="/resultat-filtre-tracabilite" class="filter-form">
                @csrf
                <span class="filtre">Filtre avancé traçabilité</span>
                ...
                <input type="submit" value="Filtrer traçabilité" id="bouton_filtre">
            </form>
        </div>
    ...
    <script>
        ...
        // Formater les dates pour mobile
        document.addEventListener('DOMContentLoaded', function() {
            if (window.innerWidth <= 576) {
                const dateCells = document.querySelectorAll('td[data-label="Date et Heure"]');
                dateCells.forEach(cell => {
                    const originalDate = cell.textContent;
                    // Formater la date pour mobile (vous pouvez ajuster le format)
                    cell.textContent = originalDate; // Garder le format original ou formater différemment
                });
            }
        });
    </script>
