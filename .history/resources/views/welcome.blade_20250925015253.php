...
<body>
    <header class="header-pro">
        <div class="header-content">
            <div class="logo-title">
                <img src="logo-minsante.png" alt="logo_dep" class="logo-pro"> 
    ...
    <section class="hero-pro">
        <div class="hero-content">
            <h1>Gestion intelligente des dossiers<br><span class="hero-highlight">Ministère de la Santé Publique du Cameroun</span></h1>
            <p class="hero-desc">Une plateforme moderne, sécurisée et collaborative pour la gestion, le suivi et la traçabilité des dossiers internes et externes. Pensée pour les agents <b>et</b> les utilisateurs externes (citoyens, partenaires, institutions).</p>
            <div class="hero-cta">
                <a href="/connexion" class="cta-btn cta-login">Se connecter</a>
                <a href="/s'inscrire" class="cta-btn cta-register">Créer un compte</a>
            </div>
        </div>
        <div class="hero-img">
            <img src="/build/flux_dossier.png" alt="Illustration gestion dossier" style="max-width:100%;height:auto;border-radius:14px;box-shadow:0 2px 8px rgba(71,61,131,0.09);">
        </div>
    </section>
