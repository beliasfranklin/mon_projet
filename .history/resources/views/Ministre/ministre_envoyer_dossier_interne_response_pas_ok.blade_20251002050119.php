...
<body>
    ...
    <div class="espace_travail">
        ...
        <div class="boite-reponse">
            <i class="fa-solid fa-circle-check"></i> Dossier interne pas envoyé car pas de membre du sécrétariat de la DEP disponible !
        </div>
        ...
        <div class="formulaire_creer_utilisateur">
            <form action="/traiter_formulaire_envoi_dossier_interne" method="post" enctype="multipart/form-data" id="dossierForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nom" id="nom" placeholder="Intitulé du dossier" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="priorites" id="priorites">
                        <option value="urgente">Urgente <span class="priority-option priority-urgente">URGENT</span></option>
                ...
                <div class="form-group">
                    ...
                    <textarea name="commentaires" id="commentaires" placeholder="Commentaires sur le dossier"></textarea>
                </div>
