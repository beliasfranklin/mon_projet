...
class MonController extends Controller
{
    ...
    public function envoyerCode(Request $request){
        ...
        // Générer un code unique et stocker avec expiration (15 min)
        ...
        // Envoyer le code par notification/email
    ...
    public function reinitialiserMotDePasse(Request $request){
        $request->validate([
            ...
            'user_id.required' => "L'utilisateur est introuvable.",
        ...
        // Optionnel : notifier l'utilisateur du changement de mot de passe
