...
class MonController extends Controller
{
    ...
    public function traiterFormulaireDossierInterne(Request $request){
        ...
        if($user_id){
            ...
            //verifier si un membre du secretariat de la DEP est connecté pourqu'il puisse recevoir le dossier
            $all_users_DEP=UserRole::where('id_role',18)->get();
            $all_users_DEP_statut=StatutUser::where('statut','disponible')->get();
    ...
    public function traiterFormulaireDossierExterne(Request $request){
        ...
        if($user_id){
            ...
            //verifier si un membre du courrier est connecté pourqu'il puisse recevoir le dossier
