    ...
    public function traiterFormulaireDossierExterne(Request $request){
        ...
        if($user_id){
            ...
            if($membre_connecte){
                ...
                $action->nomAction="l'utilisateur".$user->name."n'a pas pu envoyer un dossier intitulé".$dossier->intitule." au courrier de la DEP et à été recu par ".$membre_connecte->name;
                $action->id_user=$user->id;
