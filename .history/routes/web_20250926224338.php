...
Route::post('/traiter_login',[MonController::class,'traiterLogin'])->middleware('web');
// Gestion session et CSRF
Route::post('/traiter_login',[MonController::class,'traiterLogin'])->middleware('web');
...
Route::post('/envoi_code',[MonController::class,'envoyerCode'])->middleware('web');
...
Route::post('/verification_code',[MonController::class,'verifierCode'])->middleware('web');
...
Route::post('/reinitialiser_mot_de_passe',[MonController::class,'reinitialiserMotDePasse'])->middleware('web');
...
Route::post('/traiter_creation_compte',[MonController::class,'creerCompteUtilisateurExterne'])->middleware('web');
// Gestion session et CSRF
Route::post('/traiter_creation_compte',[MonController::class,'creerCompteUtilisateurExterne'])->middleware('web');
