...
Route::get('/recevoir_code/error',function(){
    return view('recevoir_code_error');
});

//renvoi du code de vérification
Route::get('/renvoi_code',[MonController::class,'renvoyerCode']);
...
Route::get('/reinitialisation_mdp/user/{id}',function($id){
    $user_eamil=User::where('id',$id)->get()->first();
    return view('reinitialisation_mot_de_passe',compact('user_eamil'));
});
